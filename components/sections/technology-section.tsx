...
export function TechnologySection() {
  ...
  const descriptionText = "Blue Interiors uses BWP 710-grade plywood, Häfele hardware, and branded fittings in every project. Our in-house production unit ensures precision manufacturing and quality control. From design concept to final handover, we deliver within 45 working days — with a 10-year warranty on every installation.";
  ...
  return (
    <section ref={sectionRef} className="relative bg-foreground">
      ...
      <div 
        ref={textSectionRef}
        className="relative overflow-hidden px-6 py-24 md:px-12 md:py-32 lg:px-20 lg:py-40"
      >
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/proj-kitchen-1.jpg"
        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          ...
          <div className="mt-12 flex flex-wrap gap-6">
            {[
              { label: "Project Completion", value: "45 Days" },
              { label: "Material Warranty", value: "10 Years" },
              { label: "Homes Delivered", value: "5,000+" },
            ].map((item, i) => (
              <div key={i} className="border-l border-accent pl-4">
